...
#define __yres__
  ...
  */
  ...
  #define ID_SMSB1         0x08D2
  #define ID_SMSB2         0x08D3
  #define ID_SMST0         0x08D4
  #define ID_SMST1         0x08D5
  #define ID_SMST2         0x08D6
  #define ID_SMST3         0x08D7
  #define ID_SMSH0         0x08D8
  #define ID_SMSD0         0x08D9
  #define ID_SMSH1         0x08DA
  #define ID_SMSD1         0x08DB
  #define ID_SMSH2         0x08DC
  #define ID_SMSD2         0x08DD
  #define ID_SMSH3         0x08DE
  ...
  */
  ...
  #define ID_SER01         0x08D2
  #define ID_SER02         0x08D3
  #define ID_SER03         0x08D4
  #define ID_SER10         0x08D5
  #define ID_SER11         0x08D6
  ...
  */
  ...
  #define ID_RGM01         0x0902
  #define ID_RGM02         0x0903
  #define ID_RGM03         0x0904
  #define ID_RGM04         0x0905
  #define ID_RGM05         0x0906
  #define ID_RGM06         0x0907
  #define ID_RGM07         0x0908
  #define ID_RGM08         0x0909
  #define ID_RGM09         0x090A
  #define ID_RGM10         0x0910
  #define ID_RGM11         0x0911
  #define ID_RGM12         0x0912
  #define ID_RGM20         0x0920
  #define ID_RGM21         0x0921
  #define ID_RGM22         0x0922
  #define ID_RGM23         0x0923
  #define ID_RGM24         0x0924
  #define ID_RGM25         0x0925
  #define ID_RGM26         0x0926
  #define ID_RGM27         0x0927
  #define ID_RGM28         0x0928
  #define ID_RGM29         0x0929
  #define ID_RGM2A         0x092A
  #define ID_RGM2B         0x092B
  #define ID_RGM2C         0x092C
  #define ID_RGM2D         0x092D
  #define ID_RGM2E         0x092E
  #define ID_RGM2F         0x092F
  #define ID_RGM30         0x0930
  #define ID_RGM31         0x0931
  #define ID_RGM32         0x0932
  #define ID_RGM33         0x0933
  #define ID_RGM34         0x0934
  #define ID_RGM35         0x0935
  #define ID_RGM36         0x0936
  #define ID_RGM37         0x0937
  #define ID_RGM38         0x0938
  #define ID_RGM39         0x0939
  #define ID_RGM3A         0x093A
  #define ID_RGM3B         0x093B
  #define ID_RGM3C         0x093C
  #define ID_RGM3D         0x093D
  ...
  */
  ...
  #define ID_MMM22         0x0962
  #define ID_MMM23         0x0963
  #define ID_MMM24         0x0964
  #define ID_MMM25         0x0965
  #define ID_MMM26         0x0966
  #define ID_MMM27         0x0967
  ...
  */
  ...
  #define ID_MPN01         0x09A2
  #define ID_MPN02         0x09A3
  #define ID_MPN03         0x09A4
  #define ID_MPN04         0x09A5
  #define ID_MPN05         0x09A6
  #define ID_MPN10         0x09A7
  ...
  #define ID_MPQ11         0x09B3
  #define ID_MPQ20         0x09B4
  #define ID_GTPIN         0x09C0
  #define ID_GTP00         0x09C1
  #define ID_GTP01         0x09C2
  #define ID_GTP02         0x09C3
  #define ID_GTP03         0x09C4
  #define ID_GTP04         0x09C5
  #define ID_GTP05         0x09C6
  #define ID_GTP06         0x09C7
  #define ID_GTP10         0x09C8
  #define ID_GTP11         0x09C9
  #define ID_GTP12         0x09CA
